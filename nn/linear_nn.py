""""
    ...
    that will calculate the gradient of each parameter
...
class Node(Module):
    ...
    def __init__(self, n_in,
                 activation_func: str = "") -> None:  # this class constructor only takes one parameter as n_in that is just for defining the weight and bias of the node

        self.n_in = n_in
        self.act = activation_func
        # initialising the hei initializer for uniform initialization of weights 
        # it is generally recommended that we should not initialise all the weight of a node with random number or zeros or any constants.
...
class Linear(Module):
    ...
    def __init__(self, in_feature: int = None, out_feature: int = None, learning_rate=0.01, decay_rate=0.1) -> None:
        ...
        # here initialization of weights will be done on the basis of xavier rules
        ...
        # bias is chosen randomly anything using numpy random function
